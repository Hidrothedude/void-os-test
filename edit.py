...
class TextEditor:
  ...
  def __init__(self,root):
    ...
    # Initializing Status
    self.status.set("Welcome To Void-EDIT")
    # Creating Menubar
  ...
  def infoabout(self):
    messagebox.showinfo("About Text Editor","Void-EDIT is a simple text editor included with the Void-OS")
